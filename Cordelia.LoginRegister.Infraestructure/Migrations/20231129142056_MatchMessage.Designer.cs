...
namespace Enfonsalaflota.Infraestructure.Migrations
{
    ...
    [Migration("20231129142056_MatchMessage")]
    partial class MatchMessage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Enfonsalaflota.Domain.Model.Match", b =>
                {
                    ...
                    b.Property<int>("VidasPlayer1")
                        .HasColumnType("integer");

                    b.Property<int>("VidasPlayer2")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Enfonsalaflota.Domain.Model.MatchMessage", b =>
                {
                    b.Property<int>("MatchMessageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("MatchMessageId"));

                    b.Property<int>("MatchId")
                        .HasColumnType("integer");

                    b.Property<string>("MatchMessageContent")
                        .HasColumnType("text");

                    b.Property<int>("MessageSenderId")
                        .HasColumnType("integer");

                    b.HasKey("MatchMessageId");

                    b.HasIndex("MatchId");

                    b.HasIndex("MessageSenderId");

                    b.ToTable("MatchMessage", "pcfapi");
                });
            ...
            modelBuilder.Entity("Enfonsalaflota.Domain.Model.Match", b =>
                {
                    b.HasOne("Cordelia.LoginRegister.Domain.Model.User", "PlayerWinner")
                        .WithMany("WinnerInMatches")
                    ...
                    b.HasOne("Cordelia.LoginRegister.Domain.Model.User", "PlayerTurn")
                        .WithMany("HasTurnInMatches")
            ...
            modelBuilder.Entity("Enfonsalaflota.Domain.Model.MatchMessage", b =>
                {
                    b.HasOne("Enfonsalaflota.Domain.Model.Match", "Match")
                        .WithMany("MatchMessage")
            ...
            modelBuilder.Entity("Cordelia.LoginRegister.Domain.Model.User", b =>
                {
                    ...
                    b.Navigation("WinnerInMatches");
                });

            modelBuilder.Entity("Enfonsalaflota.Domain.Model.Match", b =>
                {
                    b.Navigation("MatchMessage");
                });
